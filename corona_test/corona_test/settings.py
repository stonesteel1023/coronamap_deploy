"""
Django settings for corona_test project.
...
SECRET_KEY = '(%*z2()nv%0fkk7gih9!88!hs6c$2d^@i8xbnx1pgxr+6mmqi+'
...
WSGI_APPLICATION = 'corona_test.wsgi.application'
